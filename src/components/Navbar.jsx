    ...
    return (
        <nav className='w-max mx-auto rounded-full py-2 px-2 bg-black flex justify-center my-4'>
            <div className=" w-max flex gap-3">
                ...
                <a href="https://flyer.intuition.box/" className="cursor-pointer text-left rounded-full font-semibold text-white leading-none py-2 px-6 flex items-center gap-2">Intuition <br /> Flier <RiFilePaper2Line /></a>
