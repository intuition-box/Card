    ...
    return (
        <nav className='w-max mx-auto rounded-full py-2 px-2 bg-black flex justify-center my-4'>
            <div className=" w-max flex gap-3">
                <button className='cursor-pointer rounded-full font-semibold bg-white leading-none text-black py-2 px-6 flex items-center gap-2'>Intuit ID <FaAddressCard /> </button>
